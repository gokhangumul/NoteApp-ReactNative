...
import { 
    ...
    UserCategories,
    UpdateShareUsr,
    UpdateShareSys } from '../../actions/index';

class ShareUpdateWithMe extends Component {
    state = { 
        usr: [], 
        sys: [], 
        NoteTitle: '', 
...
export default connect(mapStateToProps, 
    { UserCategories,
      SystemCategory,
      UpdateShareUsr,
      UpdateShareSys })(ShareUpdateWithMe);
